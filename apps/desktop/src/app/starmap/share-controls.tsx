      ...
      >
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="group/code relative">
            <textarea
              aria-label={t.starmap.shareTitle}
              className="h-24 w-full resize-none rounded-md bg-foreground/5 p-2.5 pr-9 font-mono text-xs leading-relaxed break-all text-muted-foreground/90 outline-none transition placeholder:text-muted-foreground focus-visible:text-foreground focus-visible:ring-1 focus-visible:ring-ring/40"
              onChange={e => {
