...
export function FeaturedProviderRow({
  ...
  return (
    <button
      className="group relative flex w-full items-center justify-between gap-4 rounded-lg bg-primary/[0.06] px-3 py-2.5 text-left transition-colors hover:bg-primary/10"
