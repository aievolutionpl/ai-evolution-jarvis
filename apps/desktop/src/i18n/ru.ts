...
export const ru = defineLocale({
  ...
  settings: {
    ...
    character: {
      applies: 'Применится при следующем голосовом ответе.',
      characterHint: 'Кто отвечает: тексты на главном экране и персона, которую агент записывает себе.',
      characterLabel: 'Ассистент',
      recommended: 'Голос по умолчанию',
      title: 'Ассистент и голос',
      voiceHint: 'Голоса принадлежат ассистенту — при смене ассистента возвращается его собственный голос.',
      voiceLabel: 'Голос'
    },
    plugins: {
