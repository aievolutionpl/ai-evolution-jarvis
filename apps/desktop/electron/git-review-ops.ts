...
function gitFor(cwd, gitBin) {
  ...
  // validation rejects paths containing spaces or other restricted characters,
  // which silently broke the Review pane on some Windows installations.
  // For resolved paths, opt into simple-git's trusted-binary escape hatch instead
