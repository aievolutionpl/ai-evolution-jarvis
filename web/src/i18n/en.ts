...
export const en: Translations = {
  ...
  command: {
    ...
    systemsDegraded: "Attention required",
    ...
    disk: "Disk",
    load: "Load",
    statsUnavailable: "Install psutil for live CPU / memory telemetry.",
    jobs: "Active jobs",
    jobsEmpty: "No scheduled jobs yet.",
    ...
    healthActive: "Scheduled",
    healthPaused: "Paused",
    healthFailing: "Failing",
    healthDone: "Done",
    news: "AI news feed",
    newsEmpty: "No headlines match.",
    newsUnavailable: "News feeds are unreachable right now.",
    newsSearch: "Filter headlines…",
    newsAllSources: "All sources",
    newsFeedsHint: "Customize sources with dashboard.news_feeds in config.yaml.",
    sessions: "Live sessions",
    sessionsEmpty: "No sessions yet — start a chat.",
    resumeSession: "Resume",
    activity: "Activity stream",
    activityEmpty: "No recent log lines.",
    actions: "Quick actions",
    actionChat: "New chat",
    actionJob: "Schedule job",
    actionModels: "Switch model",
    actionSkills: "Skills",
    actionLogs: "Logs",
    actionSystem: "Diagnostics",
    customize: "Customize",
    widgets: "Widgets",
