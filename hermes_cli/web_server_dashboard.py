...
_BUILTIN_DASHBOARD_THEMES = [
    ...
    {"name": "rose",      "label": "Rosé",           "description": "Soft pink and warm ivory — easy on the eyes"},    {"name": "jarvis",    "label": "J.A.R.V.I.S.",   "description": "Holographic cyan HUD — sci-fi command deck"},
]
